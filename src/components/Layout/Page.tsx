...
export const PageTitle = tw.h1`transition-all text-7xl font-lexend leading-normal font-black hocus:(font-bold) text-transparent bg-clip-text bg-gradient-to-br from-primary to-secondary`;
